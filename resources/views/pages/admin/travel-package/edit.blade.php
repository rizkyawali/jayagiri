...
@section('title', 'Ubah Paket Travel - {{ $item->title }}')
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('travel-package.update', $item->id) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea name="about" id="" rows="10" class="d-block w-100 form-control">
                        {{ $item->about }}
                    </textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="type" placeholder="Travel Type" value="{{ $item->type }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-block">
                        <i class="fa fa-check fa-sm"></i> Update
                    </button>
                </div> 
            </form>
        </div>
